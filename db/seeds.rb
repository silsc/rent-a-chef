...
martin = Chef.create!(user: User.first, name: 'Martin Berasate', category: 'Vegetarian', location: 'Basque', description: 'famous international chef, amazing food', price: 150.5)
...
yamamoto = Chef.create!(user: User.first, name: 'Seiji Yamamoto', category: 'Asian', location: 'Osaka', description: 'famous international chef, amazing food', price: 300)
...
nigella = Chef.create!(user: User.first, name: 'Nigella Lawson',category: 'Italian', location: 'Lisbon', description: 'famous international chef, amazing food', price: 400)
...
clare = Chef.create!(user: User.first, name: 'Clare Smyth', category: 'Dessert', location: 'London', description: 'famous international chef, amazing food', price: 57.8)
...
chris= Chef.create!(user: User.first, name: 'Christina Tosi', category: 'Dessert', location: 'Rome', description: 'cakes are my life and chocolate is my religion', price: 70)
