...
yamamoto = Chef.create!(user: User.first, name: 'Seiji Yamamoto', category: 'Vegetarian', location: 'Osaka', description: 'famous international chef, amazing food', price: 300)
